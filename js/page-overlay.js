			...
			var self = this,
				...
				_openPanel = function() {
					...
					if( self.options.position === 'top' && self.options.display ==="push"  ){
						self._wrapper.css(
							{
								'-webkit-transform': 'translate3d(0,' + panelHeight  +'px,0)',
								'-moz-transform':'translate3d(0,' + panelHeight + 'px,0)',
								'transform':'translate3d(0,' + panelHeight + 'px,0)'
							}
						);
						self._fixedToolbar.css(
							{
								'-webkit-transform': 'translate3d(0,' + panelHeight  +'px,0)',
								'-moz-transform':'translate3d(0,' + panelHeight + 'px,0)',
								'transform':'translate3d(0,' + panelHeight + 'px,0)'
		...
		if ( this._open ) {
			var o = this.options,
				...
				_closePanel = function() {
					...
					//css transform for page content when top panel closes in push mode
					if( self.options.position === 'top' && self.options.display ==="push"  ){
						self._wrapper.css(
							{
								'-webkit-transform': '',
